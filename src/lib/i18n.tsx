...
const dict: Dict = {
  ...
  brandingHint: {
    ...
    en: 'The app’s name, logo and accent color — applied everywhere: sidebar, login, public pages, browser tab (favicon) and emails.',
  },
  brandName: { de: 'Name der App', en: 'App name' },
  brandLogo: { de: 'Logo & Favicon', en: 'Logo & favicon' },
  brandLogoHint: {
    de: 'PNG, JPEG oder WebP; du schneidest es quadratisch zu. Transparenz bleibt erhalten.',
    en: 'PNG, JPEG or WebP; you crop it to a square. Transparency is kept.',
  },
  brandLogoDefault: { de: 'Standardlogo verwenden', en: 'Use default logo' },
  brandLogoInvert: {
    de: 'Im Dunkelmodus invertieren (für dunkle Logos auf transparentem Hintergrund)',
    en: 'Invert in dark mode (for dark logos on a transparent background)',
  },
  brandAccent: { de: 'Akzentfarbe', en: 'Accent color' },
  brandAccentReset: { de: 'Auf Standard zurücksetzen', en: 'Reset to default' },
  brandDefaultValue: { de: 'Standard', en: 'Default' },
  brandPreviewButton: { de: 'Akzent-Button', en: 'Accent button' },
  brandingReloadHint: {
    de: 'Beim Speichern wird die Seite neu geladen, damit das Branding überall gilt.',
    en: 'Saving reloads the page so the branding applies everywhere.',
  },
  imprint: { de: 'Impressum', en: 'Imprint' },
  privacyPolicy: { de: 'Datenschutz', en: 'Privacy' },
  legalNotices: { de: 'Rechtliches', en: 'Legal' },
  legalModeNone: { de: 'Keine Angabe', en: 'Not set' },
  legalModeText: { de: 'Eigener Text', en: 'Own text' },
  legalModeLink: { de: 'Externe Seite', en: 'External page' },
  legalUrlLabel: { de: 'Link zur Seite', en: 'Link to the page' },
  legalUrlInvalid: {
    de: 'Bitte eine vollständige Adresse mit http:// oder https:// eingeben.',
    en: 'Please enter a full address starting with http:// or https://.',
  },
  viewLegalPage: { de: 'Seite ansehen', en: 'View page' },
  openLegalPage: { de: 'Zur Seite', en: 'Open page' },
  legalPageMissing: { de: 'Hier ist noch nichts hinterlegt.', en: 'Nothing has been set up here yet.' },
  imprintHint: {
    de: 'Wird dezent auf der Login-Seite, den Anmeldeformularen und den Check-in-Seiten verlinkt.',
    en: 'Linked subtly from the login page, registration forms and check-in pages.',
  },
  imprintTextLabel: { de: 'Impressumstext', en: 'Imprint text' },
  imprintTextHint: {
    de: 'Wird öffentlich unter /impressum angezeigt. Markdown: Überschriften, fett, Listen, Links.',
    en: 'Shown publicly at /impressum. Markdown: headings, bold, lists, links.',
  },
  imprintTextPlaceholder: {
    de: 'Angaben gemäß § 5 DDG\n\nVerein e.V.\nMusterstraße 1\n12345 Musterstadt\n\nVertreten durch: …\nKontakt: …',
    en: 'Information according to § 5 DDG\n\nClub e.V.\nSample Street 1\n12345 Sample City\n\nRepresented by: …\nContact: …',
  },
  privacyHint: {
    de: 'Wird neben dem Impressum verlinkt und im Anmeldeformular bei der Datenschutz-Zustimmung.',
    en: 'Linked next to the imprint and in the registration form’s privacy consent.',
  },
  privacyTextLabel: { de: 'Datenschutzerklärung', en: 'Privacy policy' },
  privacyTextHint: {
    de: 'Wird öffentlich unter /datenschutz angezeigt. Markdown: Überschriften, fett, Listen, Links.',
    en: 'Shown publicly at /datenschutz. Markdown: headings, bold, lists, links.',
  },
  privacyTextPlaceholder: {
  ...
  adminSecurity: { de: 'Sicherheit', en: 'Security' },
  ...
  cropSquareHint: {
    de: 'Verschiebe das Bild und zoome hinein, bis der Ausschnitt passt. Das Titelbild ist quadratisch.',
    en: 'Drag the image and zoom until the frame fits. The cover is square.',
  },
  ...
  sumTotal: { de: 'Gesamt', en: 'Total' },
  mailStats: { de: 'Versandstatistik', en: 'Sending statistics' },
  mailStatsHint: {
    de: 'Alle E-Mails der App. Gespeichert werden nur Zeitpunkt, Art und Erfolg – keine Empfänger oder Inhalte.',
    en: 'All emails the app sends. Only time, kind and outcome are stored — no recipients or content.',
  },
  timeRange: { de: 'Zeitraum', en: 'Time range' },
  range7d: { de: '7 Tage', en: '7 days' },
  range30d: { de: '30 Tage', en: '30 days' },
  range90d: { de: '90 Tage', en: '90 days' },
  range12m: { de: '12 Monate', en: '12 months' },
  mailsSent: { de: 'Gesendet', en: 'Sent' },
  mailsFailed: { de: 'Fehlgeschlagen', en: 'Failed' },
  mailsFailedHint: { de: 'Details unten', en: 'Details below' },
  mailSuccessRate: { de: 'Erfolgsquote', en: 'Success rate' },
  mailLastSent: { de: 'Zuletzt gesendet', en: 'Last sent' },
  vsPreviousPeriod: { de: '{change} ggü. Vorzeitraum', en: '{change} vs. previous period' },
  noPreviousPeriod: { de: 'Im Vorzeitraum keine', en: 'None in the previous period' },
  noMailsInRange: { de: 'In diesem Zeitraum wurden keine E-Mails versendet.', en: 'No emails were sent in this period.' },
  mailKindAccount: { de: 'Konto', en: 'Account' },
  mailKindReminder: { de: 'Erinnerungen', en: 'Reminders' },
  mailKindStatus: { de: 'Statusänderungen', en: 'Status changes' },
  mailKindWeekly: { de: 'Wochenübersicht', en: 'Weekly summary' },
  mailKindTest: { de: 'Test', en: 'Test' },
  showTable: { de: 'Als Tabelle', en: 'Show table' },
  showChart: { de: 'Als Diagramm', en: 'Show chart' },
  day: { de: 'Tag', en: 'Day' },
  month: { de: 'Monat', en: 'Month' },
  failedCount: { de: '{n} fehlgeschlagen', en: '{n} failed' },
  mailErrors: { de: 'Fehler beim Versand', en: 'Sending errors' },
  mailLastFailed: { de: 'zuletzt {date}', en: 'last {date}' },
  ...
  noGroupChoice: { de: 'Keine Angabe', en: 'Not specified' },
  ...
  participatingYes: { de: 'Ich nehme teil', en: 'Participating' },
  participatingNo: { de: 'Nehme nicht teil', en: 'Not participating' },
  ...
  privacyReadMore: { de: 'Mehr dazu:', en: 'More:' },
  acceptPrivacy: {
  ...
  registrationCoverHint: {
    de: 'Wird quadratisch groß neben dem Formular gezeigt; du schneidest es beim Hochladen zu. Ohne Bild ist die Seite einspaltig.',
    en: 'Shown as a large square next to the form; you crop it when uploading. Without one the page has a single column.',
  },
