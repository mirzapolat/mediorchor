...
//   1. window.__APP_CONFIG__  — injected at container start (see docker/env.sh),
...
// A placeholder value is what docker/env.sh writes when an env var is unset; it
// must be treated as "not provided".
