...
const dict: Dict = {
  ...
  mailNotConfiguredHint: {
    de: 'Trage unten einen SMTP-Server ein (oder setze SMTP_HOST und SMTP_FROM in der Server-Umgebung). Ohne E-Mail gibt es keine Bestätigungslinks und keine Benachrichtigungen.',
    en: 'Enter an SMTP server below (or set SMTP_HOST and SMTP_FROM in the server environment). Without email there are no confirmation links and no notifications.',
  },
  ...
  sendTestMail: { de: 'Test-E-Mail senden', en: 'Send test email' },
  testMailSent: { de: 'Test-E-Mail an {to} gesendet.', en: 'Test email sent to {to}.' },
  saved: { de: 'Gespeichert', en: 'Saved' },
  smtpPort: { de: 'Port', en: 'Port' },
  smtpSecurity: { de: 'Verschlüsselung', en: 'Encryption' },
  smtpSecurityStarttls: { de: 'STARTTLS (meist Port 587)', en: 'STARTTLS (usually port 587)' },
  smtpSecurityTls: { de: 'SSL/TLS (meist Port 465)', en: 'SSL/TLS (usually port 465)' },
  smtpSecurityNone: { de: 'Keine (unverschlüsselt)', en: 'None (unencrypted)' },
  smtpSecurityNoneHint: {
    de: 'E-Mails und Anmeldedaten gehen im Klartext über das Netz. Nur für einen lokalen Relay-Server verwenden.',
    en: 'Emails and credentials travel the network in plain text. Only use this for a local relay server.',
  },
  smtpPasswordKeep: { de: 'Gespeichert – leer lassen zum Beibehalten', en: 'Stored — leave empty to keep' },
  smtpPasswordRemove: { de: 'Gespeichertes Passwort entfernen', en: 'Remove stored password' },
  smtpPasswordHint: {
    de: 'Das Passwort wird verschlüsselt gespeichert und nie wieder angezeigt. Es wird nur an diesen Server und Benutzer gesendet – bei Änderungen muss es neu eingegeben werden.',
    en: 'The password is stored encrypted and never shown again. It is only sent to this server and user — change either and you’ll need to enter it again.',
  },
  smtpPasswordUnreadable: {
    de: 'Das gespeicherte Passwort kann nicht entschlüsselt werden (Schlüssel geändert). Bitte neu eingeben.',
    en: 'The stored password can’t be decrypted (the key changed). Please enter it again.',
  },
  smtpPasswordReentry: {
    de: 'Server oder Benutzer wurden geändert – bitte das Passwort neu eingeben.',
    en: 'Server or user changed — please enter the password again.',
  },
  smtpInsecureAuth: {
    de: 'Ein Passwort wird nur verschlüsselt (TLS oder STARTTLS) an einen entfernten Server gesendet.',
    en: 'A password is only sent to a remote server over an encrypted connection (TLS or STARTTLS).',
  },
  smtpFromAddress: { de: 'Absenderadresse', en: 'Sender address' },
  smtpFromName: { de: 'Absendername', en: 'Sender name' },
  smtpRemove: { de: 'Einstellungen entfernen', en: 'Remove settings' },
  smtpRemoveConfirm: {
    de: 'Die SMTP-Einstellungen und das Passwort werden gelöscht. Danach ist der E-Mail-Versand aus.',
    en: 'The SMTP settings and password will be deleted. Email will be turned off.',
  },
  smtpRemoveConfirmEnv: {
    de: 'Die SMTP-Einstellungen und das Passwort werden gelöscht. Danach gilt wieder die Konfiguration aus der Server-Umgebung.',
    en: 'The SMTP settings and password will be deleted. The server environment’s configuration applies again.',
  },
  smtpRemoved: { de: 'Einstellungen entfernt', en: 'Settings removed' },
  smtpSourceSettings: { de: 'Konfiguriert hier in den Admin-Einstellungen.', en: 'Configured here in the admin settings.' },
  smtpSourceEnvironment: {
    de: 'Konfiguriert über die Server-Umgebung (SMTP_*). Speichern überschreibt sie mit diesen Einstellungen.',
    en: 'Configured through the server environment (SMTP_*). Saving overrides it with these settings.',
  },
  smtpTestSection: { de: 'Testen', en: 'Test' },
  smtpTestHint: {
    de: 'Testet die eingegebenen Werte, auch ungespeicherte. Speichere sie danach, damit sie gelten.',
    en: 'Tests the values as entered, even unsaved ones. Save them afterwards to put them into effect.',
  },
  smtpCheckConnection: { de: 'Verbindung prüfen', en: 'Check connection' },
  smtpConnectionOk: { de: 'Verbindung und Anmeldung erfolgreich.', en: 'Connection and sign-in succeeded.' },
  smtpTestFailed: { de: 'Fehlgeschlagen:', en: 'Failed:' },
  smtpTooManyTests: { de: 'Zu viele Tests – bitte kurz warten.', en: 'Too many tests — please wait a moment.' },
  ...
  noStatistics: {
    de: 'Noch keine Daten. Statistiken zeigen Proben mit Datum, sobald sie stattgefunden haben.',
    en: 'No data yet. Statistics show dated rehearsals once they have taken place.',
  },
  ...
  registrationCardTitle: { de: 'Anmeldung', en: 'Registration' },
  registrationWelcome: {
    de: 'Willkommen! Melde dich mit ein paar Angaben an – das dauert keine Minute.',
    en: 'Welcome! Register with a few details — it takes less than a minute.',
  },
  registerNow: { de: 'Jetzt anmelden', en: 'Register now' },
  registerWithAccount: { de: 'Mit meinem Konto anmelden', en: 'Register with my account' },
  registrationDoneTitle: { de: 'Du bist angemeldet!', en: 'You’re registered!' },
  registrationClosedTitle: { de: 'Anmeldung geschlossen', en: 'Registration closed' },
  registrationClosedHint: {
    de: 'Dieses Formular nimmt keine Anmeldungen mehr an.',
    en: 'This form no longer takes registrations.',
  },
  projectLabel: { de: 'Projekt', en: 'Project' },
  aboutRegistration: { de: 'Über', en: 'About' },
  registrationEndsIn: { de: 'Anmeldung endet {left}', en: 'Registration closes {left}' },
  registrationUntil: { de: 'Anmeldung bis {date}', en: 'Register until {date}' },
  registrationEndedAt: { de: 'Anmeldung endete am {date}', en: 'Registration closed on {date}' },
  atTime: { de: 'um {time} Uhr', en: 'at {time}' },
  registrationDeadline: { de: 'Anmeldeschluss (optional)', en: 'Registration deadline (optional)' },
  removeDeadline: { de: 'Anmeldeschluss entfernen', en: 'Remove deadline' },
  registrationDeadlineHint: {
    de: 'Ab diesem Zeitpunkt nimmt das Formular keine Anmeldungen mehr an. Leer = offen, bis du es deaktivierst.',
    en: 'From this moment the form takes no more registrations. Empty = open until you deactivate it.',
  },
  registrationDeadlinePast: {
    de: 'Dieser Zeitpunkt liegt in der Vergangenheit – das Formular nimmt keine Anmeldungen an.',
    en: 'This moment is in the past — the form takes no registrations.',
  },
  registrationClosedStatus: { de: 'Beendet', en: 'Closed' },
  registrationCover: { de: 'Titelbild (optional)', en: 'Cover image (optional)' },
  registrationCoverHint: {
    de: 'Wird groß neben dem Formular gezeigt. Ohne Bild erscheint die Seite einspaltig. Am besten quadratisch.',
    en: 'Shown large next to the form. Without one the page has a single column. Square works best.',
  },
  uploadImage: { de: 'Bild hochladen', en: 'Upload image' },
  registrationHeader: { de: 'Kopfzeile', en: 'Header' },
  registrationHeaderApp: { de: 'Logo + „{name}“', en: 'Logo + “{name}”' },
  registrationHeaderCustom: { de: 'Logo + eigener Text', en: 'Logo + custom text' },
  registrationHeaderNone: { de: 'Keine Kopfzeile', en: 'No header' },
  registrationHeaderText: { de: 'Text der Kopfzeile', en: 'Header text' },
  registrationTint: { de: 'Hintergrund-Tönung', en: 'Background tint' },
  registrationTintDefault: { de: 'Standard (Akzentfarbe)', en: 'Default (accent color)' },
  registrationTintReset: { de: 'Auf Akzentfarbe zurücksetzen', en: 'Reset to accent color' },
  replaceImage: { de: 'Bild ersetzen', en: 'Replace image' },
  registrationOpenUntil: { de: 'Offen bis {date}', en: 'Open until {date}' },
  registrationEndedOn: { de: 'Die Anmeldung endete am {date}.', en: 'Registration closed on {date}.' },
  registrationSuccess: {
